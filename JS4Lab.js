 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${friendName} and ${myName} are having lunch. We had ${food} and ${drink}.`)
...
//Answer: We can't re-assigned const const variables
 ...
 * ↓ YOUR CODE HERE ↓ */
// let foodChoice = "Cheese";
// let drinkChoice = "Margaritas";
const lunchTime = (foodChoice, drinkChoice) => {
   return `${friendName} and ${myName} are having lunch. We had ${foodChoice} and ${drinkChoice}.`
}
console.log(lunchTime('Pizza','Water'));
...
console.log(foodForTodayAndTomorrow('Pizza', 'soda', lunchTime('Cheese', 'DrPepper')))
